...
namespace ExploreTandT.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                case SignInStatus.Success:
                    ...
                    {
                        if (a.EmailId == model.Email && a.Password == model.Password)
                        {
...

        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (model.Email == "admin@gmail.com" && model.Password == "Secret-1")
                    {
        ...
        public ActionResult Redirect()
        {
            foreach (Admin a in db.Admins)
            {
                if (User.Identity.GetUserName() == a.EmailId)
                    return RedirectToAction("dashboard", "Admin");
            }
            return RedirectToAction("Index", "Account");
        }
        ...
        public ActionResult request()
        {
            ...
            foreach(Request e in db.Requests)
            {
                if(e.EmployeeId==person.Id)
                {
                    user.listofrequests.Add(e);
                }
            }
        ...
        public ActionResult Edit()
        {
            ...
            string userid = User.Identity.GetUserName();
            var p = db.Employees.Where(x => x.Email == userid).First(); //Condition to check the Id of specific person to edit only his/her details
            ...
            collection.Rank = p.Rank ;
            collection.Salary = p.Salary;
       ...
       /// </returns>
        ...
        public ActionResult Edit(RegisterViewModel collection)
        {
            try
            {
                ...
                p.Rank = collection.Rank;
                p.Salary = collection.Salary;
                db.SaveChanges();
        ...
        public ActionResult RepaymentSchedule()
        {
            ...
            foreach (RepaymentSchedule e in db.RepaymentSchedules)
            {
                if (e.EmployeeId == person.Id)
                {
                    user.listOfRepaymentSchedule.Add(e);
                }
            }
        ...
        public ActionResult SalaryDeduction()
        {
            ...
            foreach (SalaryDeduction e in db.SalaryDeductions)
            {
                if (e.EmployeeId == person.Id)
                {
                    user.Salarydeductlist.Add(e);
                }
            }
            return View(user);
        }
