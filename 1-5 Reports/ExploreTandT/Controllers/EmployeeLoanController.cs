...
namespace ExploreTandT.Controllers
{
    public class EmployeeLoanController : Controller
    {
        ...
        /// <summary>
        /// Show request list with status and Proceed for loan in case request is accepted
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// select installment plan for loan
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// show view of Add document for loan
        /// </summary>
        /// <param name="id"></param>
